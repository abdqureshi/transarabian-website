...
const About = lazy(() => import("./pages/About")),
  ...
  JobDetailsPage = lazy(() => import("./pages/JobDetails")),
  JobApplication = lazy(() => import("./pages/JobApplication")),
  ApplicationConfirmation = lazy(() => import("./pages/ApplicationConfirmation")),
  SavedJobs = lazy(() => import("./pages/SavedJobs")),
  Hire = lazy(() => import("./pages/Hire")),
  Facilities = lazy(() => import("./pages/Facilities")),
  Gallery = lazy(() => import("./pages/Gallery")),
  Contact = lazy(() => import("./pages/Contact")),
  NotFound = lazy(() => import("./pages/NotFound")),
  Account = lazy(() => import("./pages/Account")),
  CandidateDashboard = lazy(() => import("./pages/candidate/CandidateDashboard")),
  TrackApplication = lazy(() => import("./pages/TrackApplication")),
  LegalPage = lazy(() => import("./pages/LegalPage"));

const Login = lazy(() => import("./pages/auth/Login")),
  CandidateLogin = lazy(() => import("./pages/auth/CandidateLogin")),
...
const AdminLayout = lazy(() => import("./components/admin/AdminLayout")),
  ...
  AdminJobs = lazy(() => import("./pages/admin/AdminJobs")),
  JobEditor = lazy(() => import("./pages/admin/JobEditor")),
  AdminApplications = lazy(() => import("./pages/admin/AdminApplications")),
  ApplicationReview = lazy(() => import("./pages/admin/ApplicationReview")),
  AdminCandidates = lazy(() => import("./pages/admin/AdminCandidates")),
  CandidateProfilePage = lazy(() => import("./pages/admin/CandidateProfilePage")),
  AdminInterviews = lazy(() => import("./pages/admin/AdminInterviews")),
  AdminReports = lazy(() => import("./pages/admin/AdminReports")),
      ...
      <main className="page-transition">
        ...
        >
          <Routes>
            ...
            <Route
              path="/jobs/:slug/confirmation"
              element={<ApplicationConfirmation />}
            />
            <Route
              path="/application-success/:reference"
              element={<ApplicationConfirmation />}
            />
            ...
            <Route path="/account/login" element={<CandidateLogin />} />
            ...
            >
              ...
              <Route
                ...
                element={
                  <ProtectedRoute
                    roles={[ROLES.VIEWER, ROLES.ADMIN, ROLES.SUPER_ADMIN]}
                  >
                    <AdminReports />
                  </ProtectedRoute>
                }
