export const ROLES=Object.freeze({SUPER_ADMIN:"super_admin",ADMIN:"admin",RECRUITER:"recruiter",VIEWER:"viewer",CANDIDATE:"candidate"});
export const STAFF_ROLES=Object.freeze([ROLES.SUPER_ADMIN,ROLES.ADMIN,ROLES.RECRUITER,ROLES.VIEWER]);
